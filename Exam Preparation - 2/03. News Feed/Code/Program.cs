...
namespace NewsFeed {
    public class StartUp {
        public static void Main(string[] args) {
            ...
            // Attempt to add article with existing title - should not be added
            newsfeed.AddArticle(new Article("AI Revolution", "Steve Smith", 1400));
            ...
            // Get details of existing article
